          ...
          <div className="row justify-content-evenly text-center my-5">
            <div className="col d-flex flex-column align-items-center justify-content-center">
              <div className="about-text-box">
                ...
                <p>
                  Mým koníčkem je výroba dekorací.Vyrábím dekorace z přírodních
                  materiálů, z dekorativních prvků všech tvarů a barev. Začala
                  jsem s výrobou dekorací jen pro sebe a pro své známé, nicméně
                  se poptávka rozšířila a tak jsem se rozhodla, že své služby
                  nabídnu širší veřejnosti.
                </p>
              </div>
            </div>
            <div className="col d-none d-sm-block"></div>
